  ...
  <Teleport to="body">
    ...
    >
      <div
        ...
        :key="toast.id"
        :class="[
          'pointer-events-auto min-w-[320px] max-w-md rounded-xl shadow-lg p-4 flex items-start gap-3 animate-in slide-in-from-right',
      ...
      >
        ...
        >
          <div
            :class="['h-full transition-all ease-linear', progressBarClasses[toast.type]]"
