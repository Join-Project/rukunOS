  ...
  <div>
    ...
    <template v-if="isAdmin">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-600">Ringkasan aktivitas dan statistik komunitas</p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="card p-6">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-gray-900">{{ stats.totalUnits || 0 }}</p>
            ...
            <div class="w-14 h-14 bg-primary-50 rounded-xl flex items-center justify-center">
              <Icon name="heroicons:building-office" class="w-7 h-7 text-primary-600" />
            </div>
          </div>
        </div>
        ...
        <div class="card p-6">
          <div class="flex items-center justify-between">
            ...
            <div class="w-14 h-14 bg-green-50 rounded-xl flex items-center justify-center">
              <Icon name="heroicons:users" class="w-7 h-7 text-green-600" />
            </div>
          </div>
        </div>
        ...
        <div class="card p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-gray-600 mb-1">Role Aktif</p>
              <p class="text-3xl font-bold text-gray-900">{{ stats.totalRoles || 0 }}</p>
            ...
            <div class="w-14 h-14 bg-yellow-50 rounded-xl flex items-center justify-center">
              <Icon name="heroicons:shield-check" class="w-7 h-7 text-yellow-600" />
            </div>
          </div>
        </div>
        ...
        <div class="card p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-gray-600 mb-1">Komunitas</p>
            ...
            <div class="w-14 h-14 bg-purple-50 rounded-xl flex items-center justify-center">
              <Icon name="heroicons:home" class="w-7 h-7 text-purple-600" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="lg:col-span-2">
          <div class="card">
            <div class="p-6 border-b border-gray-200">
              ...
              <p class="text-sm text-gray-600 mt-1">Fitur-fitur yang sering digunakan</p>
            </div>
            <div class="p-6">
              <div class="grid grid-cols-2 gap-4">
                <NuxtLink
                  to="/units"
                  class="group p-6 border-2 border-gray-200 rounded-xl hover:border-primary-500 hover:bg-primary-50 transition-all duration-200"
                >
                  ...
                  <h3 class="font-semibold text-gray-900 mb-1">Unit</h3>
                  <p class="text-sm text-gray-600">Kelola unit properti</p>
                </NuxtLink>
                ...
                >
                  ...
                  <h3 class="font-semibold text-gray-900 mb-1">Pengguna</h3>
                  <p class="text-sm text-gray-600">Kelola warga</p>
                </NuxtLink>
                ...
                >
                  <div class="w-12 h-12 bg-yellow-100 rounded-xl flex items-center justify-center mb-4 group-hover:bg-yellow-200 transition-colors">
                    <Icon name="heroicons:shield-check" class="w-6 h-6 text-yellow-600" />
                  </div>
                  <h3 class="font-semibold text-gray-900 mb-1">Role</h3>
                  <p class="text-sm text-gray-600">Kelola role & izin</p>
                </NuxtLink>
      ...
      <div class="max-w-5xl mx-auto space-y-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p class="text-gray-500">{{ greeting }}, {{ authStore.user?.full_name || 'Warga' }}</p>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="card p-6">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-sm font-medium text-gray-600 mb-1">Tagihan Saya</p>
                <p class="text-2xl font-bold text-gray-900">{{ stats.myBills || 0 }}</p>
          ...
          <div class="card p-6">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-sm font-medium text-gray-600 mb-1">Pengumuman</p>
                <p class="text-2xl font-bold text-gray-900">{{ stats.announcements || 0 }}</p>
                <p class="text-xs text-gray-500 mt-1">Pengumuman baru</p>
              </div>
              <div class="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center">
                <Icon name="heroicons:megaphone" class="w-6 h-6 text-purple-600" />
              </div>
            </div>
          </div>
