        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select v-model="form.priority" class="block w-full border-gray-300 rounded-xl shadow-sm focus:ring-primary-500 focus:border-primary-500 py-3 px-4">
          ...
          <div class="flex justify-end pt-4 border-t border-gray-50">
            ...
            <button 
              ...
              :class="['px-6 py-2 bg-primary-600 text-white rounded-xl font-medium hover:bg-primary-700 shadow-lg shadow-primary-600/20 transition-all', (saving || !form.title || !form.content) ? 'opacity-50 cursor-not-allowed' : '']"
            >
...
const saveAnnouncement = async (e?: Event) => {
  ...
  if (!form.title || !form.content) {
    console.log('Validation failed:', { title: form.title, content: form.content })
